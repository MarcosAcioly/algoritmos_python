...
print(f"A temperatura em graus Farenheit é: {celsius:.2f}")
...
# Solicitando ao usuário a temperatura em graus Celsius
celsius = float(input("Digite a temperatura em graus Celsius: "))

# Convertendo para graus Fahrenheit usando a fórmula
